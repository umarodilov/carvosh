...
// export async function getStats() {
//     const r = await fetch(`${API}/api/stats`);
//     if (!r.ok) throw new Error("stats load failed");
//     return r.json();
// }
//
// // ===== AUTH =====
...
//         body: JSON.stringify(payload),
//     });
//     if (!r.ok) throw new Error("service insert failed");
//     return r.json();
// }
//
// export async function updateService(id, payload) {
...
//         body: JSON.stringify(payload),
//     });
//     if (!r.ok) throw new Error("service update failed");
//     return r.json();
// }
//
// export async function deleteService(id) {
...
//         headers: authHeaders(),
//     });
//     if (!r.ok) throw new Error("service delete failed");
//     return r.json();
// }
//
// // const API = import.meta.env.VITE_API_URL || "http://localhost:4000";
...
// //
// //     const data = await r.json();
// //     localStorage.setItem("token", data.token); // 👈 муҳим
// //     return data.user;
// // }
// //
// // export async function getMe() {
